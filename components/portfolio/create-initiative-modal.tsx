...
import type { PortfolioGoalCreateInput, PortfolioGoalStatus, PortfolioGoalType } from "@/lib/portfolio/types";
...
interface CreateGoalModalProps {
  isOpen: boolean;
  onClose: () => void;
  onCreate: (input: PortfolioGoalCreateInput) => Promise<void>;
...
export function CreateGoalModal({
  ...
  const [type, setType] = useState<PortfolioGoalType>("Objective");
  const [status, setStatus] = useState<PortfolioGoalStatus>("OnTrack");
        ...
        <div className="grid grid-cols-2 gap-4">
          <FormField
            ...
            onChange={(event: ChangeEvent<HTMLSelectElement>) =>
              setType(event.target.value as PortfolioGoalType)
            }
          >
          ...
          <FormField
            ...
            value={status}
            onChange={(event: ChangeEvent<HTMLSelectElement>) =>
              setStatus(event.target.value as PortfolioGoalStatus)
            }
          >
